...
export default function PWAStatus() {
  const { isOnline, isInstallable, isInstalled, installApp, offlineReady } = usePWA()
    ...
    <div className='flex items-center space-x-2'>
      ...
      <div className='flex items-center space-x-1'>
        ...
        {!isOnline && offlineReady && (
          <span className='text-xs text-muted-foreground hidden sm:inline'>Offline Ready</span>
        )}
      </div>
