    ...
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="bg-card border border-border rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          {/* Install Status */}
          <div className="flex items-center space-x-3 p-4 bg-background rounded-lg">
            <Smartphone className={`h-8 w-8 ${isInstalled ? 'text-green-500' : 'text-muted-foreground'}`} />
            <div>
          ...
          <div className="flex items-center space-x-3 p-4 bg-background rounded-lg">
            <HardDrive className={`h-8 w-8 ${offlineReady ? 'text-green-500' : 'text-muted-foreground'}`} />
            <div>
              <h3 className="font-medium">Offline Ready</h3>
              <p className="text-sm text-muted-foreground">
                {offlineReady ? 'Yes' : 'Caching...'}
              </p>
            </div>
          </div>
        </div>
